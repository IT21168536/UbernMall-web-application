...
import AddOrderImage from "../components/images/add-order.jpg";
...
export default function AddOrder() {
  ...
  function sendData(e){
    ...
    axios.post("http://localhost:5000/orders/addOrder", formData).then(()=>{
      alert("Order Added")
    ...
    return(
      ...
      style= {{
        ...
        backgroundImage: `url("../images/finance-background.png")`,
