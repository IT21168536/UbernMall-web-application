...
import bagImage from './photos/bag01.jpg';

function SupllierPostView() {
  return (
    <div>
      <link
      ...
      {/* =====================search bar */}
      <form>
        <div class="flex" style={{ padding: '10px 400px 10px 400px',marginTop:'70px' }} >
          <label
            for="search-dropdown"
      ...
      <hr/>
      {/* =====================search bar */}
      <div class="container flex flex-wrap" style={{ margin:'20px 0px 0px 70px',width:'1400px'}} >
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" style={{ marginLeft:'50px',marginBottom:'10px' }}>
            <a href="#">
                <img class="p-8 rounded-t-lg" src={bagImage} alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
...
export default SupllierPostView;
